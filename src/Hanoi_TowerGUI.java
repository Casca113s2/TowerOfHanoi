...
public class Hanoi_TowerGUI extends JFrame implements Runnable {
	...
	private class ButtonHandler implements ActionListener {	
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == SolveBtn) { 
				...
				do {
					String input = JOptionPane.showInputDialog(Hanoi_TowerGUI.this, "Delay between moves? (millisecond)");
			...
			// When click 'Play' button 
				...
				if (PlayGameBtn.getText() == "Play Game") {
					...
					Button[0].setEnabled(true); // When start game just enable button 1 
	...
	// Method to solve Hanoi tower move disk fom A ---> C
